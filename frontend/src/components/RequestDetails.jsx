...
export default function RequestDetails({}) {
    ...
    return (
        <div>
        <button onClick={() => navigate('/betarequests')} style={{ fontSize: '20px', margin: '20px', marginLeft: '30px', marginTop: '25px', marginBottom: '10px', borderRadius: '10px', backgroundColor: '#82cad2', border: '2px solid gray', padding: '10px 20px' }}>Back to requests</button>
